  ...
  <div class="min-h-screen bg-gray-50 text-gray-900 antialiased lg:flex">
    ...
    >
      ...
      <nav class="flex-1 space-y-1 p-4">
        ...
        <DashboardSidebarLink v-if="shopStore.hasShop" :to="'/dashboard/reminders'" :label="t('nav.reminders')">
          <template #icon>
        ...
        <DashboardSidebarLink v-if="shopStore.hasShop" :to="'/dashboard/subscription'" :label="t('nav.subscription')">
          <template #icon>
